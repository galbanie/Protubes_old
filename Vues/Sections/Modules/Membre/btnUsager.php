    ...
    <ul id="ul1" class="ul-niveau1">
        <li class="li-1" >
            <a class="lien-img-membre" href="?page=membre">
                <img name="imgUserEspMembre" class="img-user" src="<?php if($_SESSION['membre']->getImage() !== null) echo 'getImage.php?id='.$_SESSION['membre']->getImage();else echo 'Ressources/Images/Profil_default.jpg'?>" />
